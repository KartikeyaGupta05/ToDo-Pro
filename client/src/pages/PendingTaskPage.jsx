...
const PendingTaskPage = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white">
      {/* Header */}
      <header className="flex items-center justify-center px-4 py-3 border-b border-gray-800">
        <h1 className="justify-center align-items-center text-lg font-semibold flex items-center gap-2">
          <ListTodo size={20} /> Pending Tasks
        </h1>
      </header>
